...
- 각 Expert confidence
- Risk Reviewer risk penalty
- Strategy Reviewer consensus quality / duplication penalty
- Data Quality 결과

## 기본 원칙

### Expert Strength
Expert별 rank와 confidence를 비교하되 1위와 2위 차이를 과도하게 확대하지 않는다.
...
### Risk
위험은 마지막 설명만 붙이지 말고 ranking에 실제 반영한다.

### Data Confidence
날짜 불일치, 핵심 필드 결측, 섹터 미매핑이 있으면 confidence를 낮춘다.
