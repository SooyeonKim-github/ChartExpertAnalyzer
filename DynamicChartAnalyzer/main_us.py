...
def parse_args():
    ...
    p.add_argument("--capital", type=float, default=10_000_000, help="Capital base; current allocation experiment is 2:6:2")
...
def main():
    ...
    print(f"Stage 1 : {plan.stage1_amount:,.0f} ({cfg.stage1_ratio:.0%})")
    print(f"Stage 2 : {plan.stage2_amount:,.0f} ({cfg.stage2_ratio:.0%})")
    print(f"Stage 3 : {plan.stage3_amount:,.0f} ({cfg.stage3_ratio:.0%})")
